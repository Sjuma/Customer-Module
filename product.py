...
class Product:
    ...
    @classmethod
    def add_product(cls, quantity=None):
        print('Add a product')
        print()
    ...
    @classmethod
    def update_products_file(cls, updated_products_list):
    ...
    @classmethod
    def update_product_records(cls):
        ...
        # Proceed to update products file
            ...
            cls.update_products_file(updated_products_list)
...
# Product.update_product_records()
